...
class Payment extends StatefulWidget {
  ...
  final String msg;
  Function updateHome, updateParent;

  Payment({this.update, this.msg, this.updateHome, this.updateParent});
...
class StatePayment extends State<Payment> with TickerProviderStateMixin {
  ...
  DateTime pickedData;
  TimeOfDay time;
  DateTime pickedData2;
  TimeOfDay time2;
  @override
  void initState() {
    pickedData2 = DateTime.now();
    time2 = TimeOfDay.now();
  ...
  _pickTime() async {
    TimeOfDay ctime = await showTimePicker(context: context, initialTime: time);
    if (ctime != null) {
      setState(() {
        time = ctime;
      });
              ...
              child: InkWell(
                ...
                onTap: () {
                  String deliveryDateTime =
                      '${pickedData.year}-${pickedData.month}-${pickedData.day} ${time.hour}:${time.minute};${pickedData2.year}-${pickedData2.month}-${pickedData2.day} ${time2.hour}:${time2.minute}';

                  Navigator.pop(context, deliveryDateTime);
                },
                child: Center(
                  child: Icon(
                                     ...
                                     */
                                      ...
                                      Column(
                                        children: [
                                          ListTile(
                                            title: Text(
                                                "Date :${pickedData.year},${pickedData.month},${pickedData.day}"),
                                            trailing:
                                      ...
                                      Column(
                                        children: [
                                          InkWell(
                                            child: ListTile(
                                              title: Text(
                                                  "Date :${pickedData2.year},${pickedData2.month},${pickedData2.day}"),
                                              trailing: Icon(
