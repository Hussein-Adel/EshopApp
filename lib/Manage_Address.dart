...
class ManageAddress extends StatefulWidget {
  ...
  const ManageAddress({Key key, this.home, this.type}) : super(key: key);
              ...
              children: [
                ...
                InkWell(
                  child: Container(
                      ...
                      child: Text(getTranslated(context, widget.type),
          ...
          onTap: () {
            if (mounted)
              setState(() {
                ...
                if (widget.type == 'ADDADDRESS_pick_Up') {
                  selectedAddressPickup = index;
                } else {
