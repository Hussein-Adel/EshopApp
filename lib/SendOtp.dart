...
class _SendOtpState extends State<SendOtp> with TickerProviderStateMixin {
  ...
  setCountryCode() {
    ...
    return CountryCodePicker(
        ...
        boxDecoration: BoxDecoration(color: colors.lightWhite,),
  ...
  verifyBtn() {
    return AppBtn(
        title: widget.title == getTranslated(context, 'SEND_OTP_TITLE') ? getTranslated(context, 'SEND_OTP') : getTranslated(context, 'GET_PASSWORD'),
        btnAnim: buttonSqueezeanimation,
        btnCntrl: buttonController,
        onBtnSelected: () async {
          validateAndSubmit();
